...
#Magma Slimy Dirt	
recipes.addShaped(<tconstruct:slime_dirt:3> * 8,
...
#Blue Slime Sapling
recipes.addShaped(<tconstruct:slime_sapling:0>, [
...
mods.jei.JEI.removeAndHide(<tconstruct:stone_ladder>);
mods.jei.JEI.removeAndHide(<tconstruct:stone_torch:0>);
