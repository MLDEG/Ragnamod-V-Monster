...
mods.extendedcrafting.TableCrafting.addShaped(0, <projecte:item.pe_philosophers_stone>,
  ...
  [null, <thaumcraft:nitor_red>, <thaumcraft:nitor_orange>, null, null, null, <thaumcraft:nitor_orange>, <thaumcraft:nitor_red>, null],
  [<thaumcraft:nitor_red>, <thaumcraft:nitor_yellow>, null, <enderio:block_alloy_endergy:4>, <enderio:block_alloy_endergy:4>, <enderio:block_alloy_endergy:4>, null, <thaumcraft:nitor_yellow>, <thaumcraft:nitor_red>],
  [<thaumcraft:nitor_yellow>, null, <enderio:block_alloy_endergy:4>, <botania:storage:4>, <botania:storage:4>, <botania:storage:4>, <enderio:block_alloy_endergy:4>, null, <thaumcraft:nitor_yellow>],
  [<thaumcraft:nitor_orange>, null, <enderio:block_alloy_endergy:4>, <botania:storage:4>, <thaumcraft:primordial_pearl>, <botania:storage:4>, <enderio:block_alloy_endergy:4>, null, <thaumcraft:nitor_orange>],
  [null, null, <enderio:block_alloy_endergy:4>, <botania:storage:4>, <botania:storage:4>, <botania:storage:4>, <enderio:block_alloy_endergy:4>, null, null],
  [null, null, null, <enderio:block_alloy_endergy:4>, <enderio:block_alloy_endergy:4>, <enderio:block_alloy_endergy:4>, null, null, null],
